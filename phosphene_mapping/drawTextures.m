...
switch texture_name
    ...
    case 'FixationCross'
        ...
        [r_pix_width, r_pix_height] = va2pixel_temp(parameters.fixationCrossSizeDeg, 'fixation');
        [inner_width, inner_height] = va2pixel_temp(parameters.fixationCrossSizeDeg/3, 'fixation');
