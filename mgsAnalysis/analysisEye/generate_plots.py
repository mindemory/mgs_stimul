    ...
    for ss in range(len(subjIDs)):
        for ii in range(len(TMSconds)):
            ...
            if normalizer == 'individualized' or normalizer == 'both':
                ...
                if ss == 12:
                    print(ss, this_mean, np.nanmean(this_prodf[error_measure]), np.nanmean(this_antidf[error_measure]))
