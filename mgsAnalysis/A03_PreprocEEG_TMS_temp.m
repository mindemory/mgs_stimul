...
%     else
%         disp('TFRs exist, loading freqmats.')
%         load(fName.freqmat_prointoVF)
%         load(fName.freqmat_prooutVF)
%         load(fName.freqmat_antiintoVF)
%         load(fName.freqmat_antioutVF)
%         if day ~= NoTMSDays(subjID)
%             load(fName.tms_freqmat_prointoVF)
%             load(fName.tms_freqmat_prooutVF)
%             load(fName.tms_freqmat_antiintoVF)
%             load(fName.tms_freqmat_antioutVF)
%         end
    end
end
