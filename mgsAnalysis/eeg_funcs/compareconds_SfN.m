function compareconds_SfN(TFR, tidx, fidx, bl_type)
...
cfg.zlim                                          = [-0.1 0.1];
subplot(3, 3, 3)
cfg.title = 'No TMS: contra - ipsi';
ft_singleplotTFR(cfg, TFRcontrast.NT)
xlabel('Time (s)')
ylabel('Frequency (Hz)')
subplot(3, 3, 6)
cfg.title = 'TMS inPF: contra - ipsi';
ft_singleplotTFR(cfg, TFRcontrast.T.(t_types{1}))
xlabel('Time (s)')
ylabel('Frequency (Hz)')
subplot(3, 3, 9)
cfg.title = 'TMS outPF: contra - ipsi';
