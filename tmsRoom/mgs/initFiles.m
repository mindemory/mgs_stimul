...
taskMapFile = [TASK_MAPS parameters.currentStudy int2strz(parameters.currentStudyVersion,2) '_sub' subNumStr '_sess' sessionNumStr '_run' runNumStr '_' task '_coilLoc' coilLocStr '_' dateStr '_' timestamp '_taskMap.mat'];
